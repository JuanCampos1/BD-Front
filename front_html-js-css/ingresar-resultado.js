document.addEventListener('DOMContentLoaded', function () {
    ...
    const ingresarResultadoBtn = document.getElementById('ingresar-resultado-btn');
    ...
    fechaInput.addEventListener('input', function () {
        ...
        if (fechasHabilitadas[selectedDate]) {
            ...
            ingresarResultadoBtn.style.display = 'block';
        } else {
            ...
            ingresarResultadoBtn.style.display = 'none';
        }
    });
